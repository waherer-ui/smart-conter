    ...
    */
    ...
    $purchase = DB::transaction(function () use (
        ...
        */
        ...
        | INDEX TERPISAH
        |
        | Karena Blade mengirim array produk lama dan produk baru
        | secara terpisah, kita tidak boleh menggunakan index yang sama.
        |--------------------------------------------------------------------------
        */
...
|--------------------------------------------------------------------------
|
| Pastikan SKU benar-benar belum digunakan
| pada store aktif.
|--------------------------------------------------------------------------
*/
    ...
    $sku =
        ...
        str_pad(
            ...
            STR_PAD_LEFT
                ...
                |
                | PENTING:
                | Stok awal langsung = jumlah pembelian.
                | Tidak menggunakan increment lagi.
                |--------------------------------------------------------------------------
                */
